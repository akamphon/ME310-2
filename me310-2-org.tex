...
\label{sec:org01cdad6}

Most shafts serve to transfer torque from an input (gear, pulley,
engine, motor, etc.) to an output gear or pulley. The shaft must be sized to support torsional stress and its resultant angle of twist. It is also important to provide a way to transmit the torque between the gear (or pulley) and the shaft itself. Common torque transfer methods are:
...
\label{sec:org573dd17}

\section{Overview of Bearings}
\label{sec:orgd486b57}

\section{What are bearings?}
\label{sec:org1aa4afc}
...
\label{sec:org76afd17}
\section{Rolling Elements}
\label{sec:org1176f88}
...
\label{sec:org9a3dffe}


\subsection{Radial Ball Bearing Selection}
\label{sec:org9b8d3e8}
...
\chapter{Gears}
\label{sec:orgd6d33d5}
\section{Gear Overview}
\label{sec:org4702093}
...
\label{sec:orgdfde0e4}
\subsection{Drum Brakes}
\label{sec:org3718414}
...
\label{sec:orgb64e91a}
\subsection{Materials}
\label{sec:orgf49ff7b}
\begin{marginfigure}
  \centering
...
\section{Drum Brake}
\label{sec:org20f262e}

\section{Internal Drum Brake}
\label{sec:orgf6e7d8b}
...
\section{Band Brakes}
\label{sec:org639669a}
\section{Principles of Band Brakes}
\label{sec:orge5d8e08}
...
\label{sec:orgb623ad9}
\section{Working Principles}
\label{sec:orga42b5b0}
...
\label{sec:orgfa9a0c2}

\subsection{Belt - Pulley Geometry}
\label{sec:org67d5ab6}
...
\section{Flat Belts}
\label{sec:org8eff810}

\subsection{Belt Tension}
\label{sec:org94a5bba}
...
\section{V-Belts}
\label{sec:org1d2095d}



\section{Why V Belts?}
\label{sec:org638547b}
...
\label{sec:org27d21fe}

\subsection{Roller Chain components}
\label{sec:orged2ef78}
