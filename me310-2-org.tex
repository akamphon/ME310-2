...
\subsubsection{Example: Shaft sizing}
\label{sec:org72561dd}
...
\subsubsection{Example: Key Sizing}
\label{sec:org695c6cb}
...
\subsubsection{Solution: Key Sizing}
\label{sec:org0f7800b}
...
\subsubsection{Example: Torque Capacity of an Interference Fit}
\label{sec:org4cf0c28}
...
\subsubsection{Solution: Torque Capacity of an Interference Fit}
\label{sec:org448737a}
...
\label{sec:orga54f15e}

\section{Overview of Bearings}
\label{sec:org1179340}

\section{What are bearings?}
\label{sec:org3b05b8e}
...
\subsubsection{Example: Sleeve Bearing for a Low-speed Shaft}
\label{sec:orgd6348b7}
...
\label{sec:org084c960}

\subsection{Roller bearings}
\label{sec:org18a657b}
...
\label{sec:org7a3bb35}


\subsection{Radial Ball Bearing Selection}
\label{sec:org2189889}
...
\subsubsection{Example: Spur gear design for a conveyor belt}
\label{sec:org6e2e470}
...
\subsubsection{Solution: spur gear design for a conveyor belt}
\label{sec:org05b8ea3}
...
\subsubsection{Example: Bevel Gearset Design}
\label{sec:org46ddb0d}
...
\subsubsection{Solution: Bevel Gearset Design}
\label{sec:org2779c8f}
...
\subsubsection{Example: Worm gear speed reducer}
\label{sec:org6c96c37}
...
\subsubsection{Solution: Worm gear speed reducer}
\label{sec:org78c2422}
...
\label{sec:org0be351e}

\section{Clutches vs Brakes}
\label{sec:org2b53e52}
...
\label{sec:org3078e09}
\subsection{Drum Brakes}
\label{sec:org1bf9963}
...
\label{sec:orga74e6d1}

\begin{center}
\includegraphics[width=.9\linewidth]{./pictures/Clutches-Brakes/band-brake.jpg}
\end{center}

\subsection{Brake Linings}
\label{sec:org01a46e5}
\subsection{Materials}
\label{sec:org502d4a3}
\begin{marginfigure}
\begin{center}
\includegraphics[width=.9\linewidth]{./pictures/Clutches-Brakes/molded-lining.jpg}
\end{center}
\end{marginfigure}
...
\begin{marginfigure}
\begin{center}
\includegraphics[width=.9\linewidth]{./pictures/Clutches-Brakes/woven-lining.jpg}
\end{center}
\end{marginfigure}
...
\begin{marginfigure}
\begin{center}
\includegraphics[width=.9\linewidth]{./pictures/Clutches-Brakes/sintered-lining.jpg}
\end{center}
\end{marginfigure}
...
\label{sec:orga00f816}

\begin{figure*}
\begin{center}
\includegraphics[width=.9\linewidth]{./pictures/Clutches-Brakes/dry-materials.png}
\end{center}
\end{figure*}

\subsection{Wet Linings}
\label{sec:orgb9d3271}
...
\section{Drum Brake}
\label{sec:orga6bbf31}

\subsection{Internal Drum Brake}
\label{sec:org49f4251}
...
\subsubsection{Example: Braking torque of a drum brake}
\label{sec:orgc76fb17}
...
\section{Band Brakes}
\label{sec:org5665a86}
\subsection{Principles of Band Brakes}
\label{sec:org5fd08da}
...
\subsubsection{Example: An Exercise Bike}
\label{sec:orgca5e333}
...
\label{sec:org23d8a05}
\subsection{Working Principles}
\label{sec:orga5f26c2}
...
\subsubsection{Example: Automotive Clutch}
\label{sec:org688f36b}
...
\subsection{Flat Belt Assembly}
\label{sec:org9dfb405}
...
\begin{center}
\includegraphics[height=0.8\textheight]{./pictures/Flexible-Elements/crowned-pulley.jpg}
\end{center}

\subsection{Belt Tension}
\label{sec:orgb4e377a}
...
and \(m\) is the \textbf{mass per length} of belt
\end{itemize}

\subsection{Force Balance on Pulley}
\label{sec:org7f24b79}

\begin{center}
\includegraphics[height=0.5\textheight]{./pictures/Flexible-Elements/forces-on-pulley.png}
\end{center}
...
\subsection{Initial Belt Tension \(F_{i}\)}
\label{sec:orge9fb6f1}
...
\subsection{Tight and Slack Side Tensions}
\label{sec:org119385b}
...
\label{sec:org13e627b}

\begin{center}
\includegraphics[width=\textwidth]{./pictures/Flexible-Elements/belt-allowable-tension.png}
\end{center}

\subsection{Pulley Correction Factor: \(C_p\)}
\label{sec:org83b2000}

\begin{center}
\includegraphics[width=\textwidth]{./pictures/Flexible-Elements/pulley-correction-factor.png}
\end{center}
...
\label{sec:orgf8a98a2}

\begin{center}
\includegraphics[width=\textwidth]{./pictures/Flexible-Elements/velocity-correction-factor.png}
\end{center}
...
\subsubsection{Example: Flat belt design}
\label{sec:org8ce848e}
...
\subsubsection{Solution: Flat belt design}
\label{sec:org647f9e9}
...
\end{align*}
\section{V-Belts}
\label{sec:org018f15c}



\subsection{Why V Belts?}
\label{sec:org970e9fd}
...
\subsubsection{Example: Design of Belts}
\label{sec:org61488a2}
...
\label{sec:org57d2956}

\subsection{Roller Chain components}
\label{sec:org341119a}
...
\subsection{Standard Chain Dimensions}
\label{sec:org8fea3be}
...
\subsection{Roller Chain Rated Capacity}
\label{sec:orgb4c3f25}
...
\label{sec:org638f87f}

\subsubsection{Example: Design of a Conveyor Belt System}
\label{sec:orgd4d9252}
...
\subsubsection{Solution: Design of a Conveyor Belt System}
\label{sec:orgc4e884e}
