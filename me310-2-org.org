...
include carburizing grades of ANSI 1020, 4320, 4820, and 8620. [cite:@shigley2011shigley]
...
- Allow positive engagement between teetch
...
- Straight involute teeth \(\rightarrow\) most common \begin{align}
              F = \frac{T}{R_{\text{pitch}} \cos \theta}
            \end{align}

- Lead to shaft bending
...
- \(k_{ms}\) :: median-stress factor (1 for two-way bending (followers),
